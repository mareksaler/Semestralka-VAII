...
<div class="container-lg bleda mt-3 pt-3">
    ...
    <div class="row">
        <div class="col-12">
            <img class="img-fluid mx-auto d-block" src="img/vysoke_tatry/Vysoké_Tatry_panorama1.jpg" height="560"
                width="1300" alt="Vysoke Tatry panorama" />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                @foreach ($tatry as $item)
                    <a href="/vysokeTatry/{{ $item->slug }}">
                        <div class="card karta m-1">
                            ...
                            <div class="card-body">
                                <a href="/vysokeTatry/{{ $item->slug }}" data-bs-toggle="modal" class="karta-nadpis" data-bs-target="">
                                    <h5 class="card-title">
                                        {{ $item->title }}
                                    </h5>
                                </a>
