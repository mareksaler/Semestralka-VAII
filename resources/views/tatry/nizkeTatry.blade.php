...
<div class="container-lg bleda mt-3 pt-3">
    ...
    <div class="row">
        <div class="col-12">
            <img class="img-fluid mx-auto d-block" src="img/nizke_tatry/nizke_tatry.jpg" height="560" width="1300"
                alt="Nizke Tatry panorama" />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
    ...
    @if (Auth::check())
    <a role="button" class="btn btn-success" href="nizkeTatry/create">
        Pridať túru
    </a>
    @endif
    ...
    <div class="row farba-text p-2">
        <div class="d-flex justify-content-start flex-wrap">
            ...
            @if (strcmp($item->area, "N") === 0)
            <a href="/nizkeTatry/{{ $item->slug }}">
                <div class="card karta m-1">

                    <img src="{{ 'img/tatry/' . $item->image }}" height="160px" class="card-img-top" alt="...">

                    <div class="card-body">
                        <a href="/nizkeTatry/{{ $item->slug }}" data-bs-toggle="modal" class="karta-nadpis"
                            data-bs-target="">
                            <h5 class="card-title">
                                {{ $item->title }}
                            </h5>
                        ...
                        <div class="row">
                            <div class="col">
                                <a role="button" class="btn btn-primary btn-sm" href="nizkeTatry/{{$item->id}}/edit">
                                    Upraviť
                                </a>
                            </div>
                            <div class="col ">
                                <form method="POST" action="/nizkeTatry/{{ $item->id }}">
                                    @csrf
                                    @method('delete')
